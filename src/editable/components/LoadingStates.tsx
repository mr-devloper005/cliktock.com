...
export function PageLoadingState({ label = 'Loading page', className }: LoadingStateProps) {
  return (
    <div className={cn('mx-auto w-full max-w-[1200px] px-4 py-12 text-white sm:px-6 lg:px-8', className)} aria-live="polite" aria-busy="true">
...
export function DetailLoadingState({ label = 'Loading detail', className }: LoadingStateProps) {
  return (
    <div className={cn('mx-auto grid w-full max-w-6xl gap-8 px-4 py-12 text-white lg:grid-cols-[0.8fr_1.2fr]', className)} aria-live="polite" aria-busy="true">
